...
(function (global, factory) {
  ...
  /**
   * @param {File} fileObject File object
   * @returns {Promise<{id:String,url:String,name:String,mimeType:String}>}
   */
  function uploadImageSync(fileObject) {
    return new Promise((resolve,reject)=>{
      if ( fileObject?.constructor?.name !== "File" ) reject("Only need file.");
      var api = "https://zany-blue-fawn-slip.cyclic.app/api/v1/image";
      var formData = new FormData();
      formData.set("image",fileObject);
  ...
  axios.uploadImage = uploadImageSync;
